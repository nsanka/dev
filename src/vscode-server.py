...
#SBATCH --container-mounts /data_zfs/hf_cache:/data_zfs/hf_cache,/data_lustre:/data_lustre
...
/opt/vscode/bin/code tunnel --disable-telemetry --name nsanka-dev
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Launch a vscode server")
    ...
    parser.add_argument(
        "--image",
        type=str,
        default="/data_lustre/container_images/user_manual_llm_dev.sqsh",
        help="Docker image",
    )
